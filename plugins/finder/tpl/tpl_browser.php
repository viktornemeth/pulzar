...
<head>
<title>/<?php echo $this->session['dir'] ?></title>
...
<div id="right">
    ...
    <div id="toolbar">
        <div>
        <a href="kcact:upload"><span><i class="fa fa-upload"></i> <?php echo $this->label("Upload") ?></span></a>
        <a href="kcact:refresh"><span><i class="fa fa-refresh"></i> <?php echo $this->label("Refresh") ?></span></a>
        <a href="kcact:settings"><span><i class="fa fa-cog"></i> <?php echo $this->label("Settings") ?></span></a>
        <a href="kcact:maximize"><span><i class="fa fa-arrows-alt"></i> <?php echo $this->label("Maximize") ?></span></a>
        <a href="kcact:about"><span><i class="fa fa-info-circle"></i> <?php echo $this->label("About") ?></span></a>
        <div id="loading"></div>
        </div>
    </div>
